...
{
		define("FILE_VIPLIST", "../vip/viplist");
		define("FILE_QUEUE", "../vip/queue");
...
else
{
		...
		define("FILE_KICKREASONS", "../lolocaust/kickreasons");
}		
...
function lolocaust_init()
{
	...
	/* We're only allowed to run once per minute. Like a boss. */
	else
	{	
		return false;
	}
